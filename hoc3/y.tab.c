...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 22 "hoc.y" /* yacc.c:1646  */
    { printf("\t%.8g\n", (yyvsp[-1].val)); }
#line 1237 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 23 "hoc.y" /* yacc.c:1646  */
    { yyerrok; }
#line 1243 "y.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 25 "hoc.y" /* yacc.c:1646  */
...
#line 28 "hoc.y" /* yacc.c:1646  */
    { if ((yyvsp[0].sym)->type == UNDEF)
			execerror("undefinded variable", (yyvsp[0].sym)->name);
		(yyval.val) = (yyvsp[0].sym)->u.val; }
#line 1257 "y.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 32 "hoc.y" /* yacc.c:1646  */
...
#line 1275 "y.tab.c" /* yacc.c:1646  */
  ...
  case 14:
#line 35 "hoc.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[-2].val) * (yyvsp[0].val); }
#line 1281 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 36 "hoc.y" /* yacc.c:1646  */
    {
			if ((yyvsp[0].val) == 0.0)
